  ...
  return (
    <div className="py-16 border-t border-gray-200">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold mb-3 text-pulo-gradient">Features</h2>
        <p className="text-lg text-gray-600">How PULO helps you achieve your fitness goals</p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="text-center p-6 group hover:bg-white hover:shadow-lg rounded-xl transition-all duration-300">
          <div className="bg-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:bg-pulo group-hover:text-white transition-colors">
            <Brain className="w-8 h-8 text-pulo group-hover:text-white transition-colors" />
          </div>
        ...
        <div className="text-center p-6 group hover:bg-white hover:shadow-lg rounded-xl transition-all duration-300">
          <div className="bg-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:bg-pulo group-hover:text-white transition-colors">
            <BarChart3 className="w-8 h-8 text-pulo group-hover:text-white transition-colors" />
          </div>
        ...
        <div className="text-center p-6 group hover:bg-white hover:shadow-lg rounded-xl transition-all duration-300">
          <div className="bg-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:bg-pulo group-hover:text-white transition-colors">
            <Calendar className="w-8 h-8 text-pulo group-hover:text-white transition-colors" />
          </div>
