    ...
    <Card className="bg-white/90 backdrop-blur-sm border-purple-300/20 shadow-xl shadow-purple-900/10">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Button 
          ...
          className="bg-white hover:bg-purple-50 hover:text-[#8E44AD] border-purple-200 transition-all duration-200"
        >
      ...
      <CardContent>
        <div className="grid grid-cols-2 gap-6">
          ...
          {!isEditing && profile && (
            <div className="bg-purple-50/70 rounded-lg p-4 border border-purple-100 col-span-2">
          ...
          <div className="col-span-2 bg-purple-50/70 rounded-lg p-4 border border-purple-100">
            ...
            {isEditing ? (
              ...
              <div className="flex items-center gap-2 text-lg font-semibold text-[#5C2D91] capitalize">
                {displayFitnessGoal === "build_muscle" && <Dumbbell className="h-5 w-5 text-[#8E44AD]" />}
                {displayFitnessGoal === "lose_fat" && <Flame className="h-5 w-5 text-[#8E44AD]" />}
                {displayFitnessGoal === "increase_mobility" && <Leaf className="h-5 w-5 text-[#8E44AD]" />}
                {displayFitnessGoal === "stay_active" && <Activity className="h-5 w-5 text-[#8E44AD]" />}
          ...
          <div className="col-span-2 bg-purple-50/70 rounded-lg p-4 border border-purple-100">
            ...
            {isEditing ? (
              ...
              <div className="flex items-center gap-2 text-lg font-semibold text-[#5C2D91] capitalize">
                {displayIntensity === "easy" && <Leaf className="h-5 w-5 text-[#8E44AD]" />}
                {displayIntensity === "moderate" && <Activity className="h-5 w-5 text-[#8E44AD]" />}
                {displayIntensity === "hard" && <Dumbbell className="h-5 w-5 text-[#8E44AD]" />}
                {displayIntensity === "intense" && <Zap className="h-5 w-5 text-[#8E44AD]" />}
                {displayIntensity}
              </div>
            )}
          </div>
            ...
            {isEditing ? (
              ...
              <div className="flex items-center gap-2 text-lg font-semibold text-[#5C2D91] capitalize">
                {profile?.workout_location === "home" ? 
                  <Home className="h-5 w-5 text-[#8E44AD]" /> : 
                  <Dumbbell className="h-5 w-5 text-[#8E44AD]" />
                }
