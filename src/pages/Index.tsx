...
const Index = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="relative overflow-hidden">
        <div 
          className="absolute inset-0 z-0 bg-cover bg-center opacity-3"
          style={{ 
